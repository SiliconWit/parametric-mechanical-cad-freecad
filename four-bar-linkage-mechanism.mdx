...
Step 3: Create Link 1 - Ground (reference master)
Step 4: Create Link 2 - Crank (reference master)
Step 5: Create Link 3 - Coupler (reference master)
Step 6: Create Link 4 - Follower (reference master)
Step 7: Assemble with pin joints
Step 8: Create technical drawing
Step 9: Test Grashof configurations
```
...
S + L = 120 ≤ P + Q = 150 (Grashof ✓, but barely)
```
