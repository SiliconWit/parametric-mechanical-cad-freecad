...
Before carving the profile in CAD, try your motion program in the [Cam and Follower Mechanism Simulator](/product-development/cam-follower-mechanism-simulator/) to plot the SVAJ diagrams, check the pressure angle and radius of curvature, and compare motion profiles. For structured experiments with Python analysis, see the [Mechanism Design and Simulation](/education/mechanism-design-simulation/) course.
:::
...
- **Simulate it:** Use the [Cam and Follower Mechanism Simulator](/product-development/cam-follower-mechanism-simulator/) to analyze the SVAJ chain, pressure angle, radius of curvature, and follower jump of the cam you just built, and adjust the motion profile in real time.
- **Run the experiments:** Work through the [Cam and Follower Experiments](/education/mechanism-design-simulation/cam-follower-experiments) for structured, Python-verified exercises.
- **Read more:** See the [2D Mechanisms Analyzer](/product-development/2d-mechanisms-analyzer/) for the full simulator set and downloadable resources.
