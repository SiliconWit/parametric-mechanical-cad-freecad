...
excerpt: "Unlock FreeCAD's full power with Python scripting for algorithmic design, lattice structures, design optimization, and batch processing—capabilities impossible with GUI alone."
---
...
```python
x(θ) = r_b × (cos(θ) + θ × sin(θ))
y(θ) = r_b × (sin(θ) - θ × cos(θ))
```

Where:
- r_b = base circle radius
- θ = unwinding angle parameter
...
<Card title="🔬 Research Case Studies" icon="star">
...
<CardGrid>
  <Card title="✅ Understood Python's Power" icon="star">
    When scripting beats GUI, what's possible with code
  </Card>

  <Card title="✅ Generated Algorithmic Geometry" icon="setting">
    Involute gears, lattice structures, mathematical shapes
  </Card>

  <Card title="✅ Implemented Optimization" icon="rocket">
    Design space exploration, iterative improvement
  </Card>

  <Card title="✅ Processed Data" icon="document">
    Point clouds, measurements, data-driven design
  </Card>

  <Card title="✅ Automated Workflows" icon="approve-check">
    Batch exports, drawing generation, mass operations
  </Card>

  <Card title="✅ Applied to Research" icon="star">
...
<Card title="📖 Recommended Resources" icon="open-book">
