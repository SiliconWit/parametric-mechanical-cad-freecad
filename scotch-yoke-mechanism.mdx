...
<div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
  <TailwindWrapper>
    ![Scotch Yoke Mechanism](https://pub-b1eb899abc464b5baf5b9521d163efd9.r2.dev/parametric-mechanical-CAD-with-FreeCAD/scotch-yoke-mechanism.gif)
  </TailwindWrapper>
</div>
...
```
Step 1: Create parameter spreadsheet (with formulas!)
Step 2: Create rotating crank with eccentric pin
Step 3: Create yoke with horizontal slot
Step 4: Create guide rails for linear constraint
Step 5: Create base frame
Step 6: Assemble with motion constraints
Step 7: Create technical drawing
Step 8: Test parametric updates and verify stroke
```
...
r = crank radius (40mm)
θ = crank angle (radians or degrees)
```

**Example calculations:**

| θ (degrees) | θ (radians) | x = 40 × sin(θ) |
|-------------|-------------|-----------------|
| 0° | 0 | 0 mm |
| 30° | π/6 | 20 mm |
| 90° | π/2 | 40 mm |
...
**At constant crank speed ω = 2 rad/s (about 19 RPM):**
...
**Key insight:** Velocity is maximum at center position (θ = 0°, 180°) and zero at extremes (θ = 90°, 270°)!
...
- Sliding velocity = r × ω × cos(θ) (not zero)
...
You've completed **Lesson 8: Scotch Yoke Mechanism** and the entire **Parametric Mechanical CAD with FreeCAD** course!
...
You've now designed eight fundamental mechanisms:
