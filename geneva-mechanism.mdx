...
<div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
  <TailwindWrapper>
    ![Geneva Mechanism](https://cdn.siliconwit.com/education/parametric-mechanical-CAD-with-FreeCAD/geneva-mechanism-6spoke.gif)
  </TailwindWrapper>
</div>
...
<Tabs>
  <TabItem label="Geometric Formula">
    ...
    **Driven wheel radius calculation:**
    ...
    $$R_g = R_d \times \tan\left(\frac{180°}{n}\right)$$
    ...
    **Slot spacing:**
    ...
    $$\text{Slot center angle} = \frac{360°}{n}$$
  ...
  <TabItem label="Timing Analysis">
    ...
    **Dwell angle:**
    ...
    $$\text{Dwell} = \frac{360° \times (n - 2)}{n}$$

    **Index duration:**

    $$\text{Index} = \frac{360°}{n}$$
...
<Tabs>
  ...
  <TabItem label="Design Workflow">
    ...
    **Build Sequence:**
    ...
    2. Create Driver Wheel (with pin)
    
    3. Create Geneva Wheel (with polar slot pattern)
    
    4. Create Frame (mounting base)
    
    5. Assemble with rotation constraints
    
    6. Create technical drawing with timing diagram
    
    7. Test parametric control (change slot count!)
    </Steps>
...
If $R_d = 40 \text{ mm}$, then $R_g \approx 23 \text{ mm}$.
...
**For 6-slot Geneva:**
- Dwell: $\frac{360° \times 4}{6} = 240°$ of driver rotation
- Index: $\frac{360° \times 1}{6} = 60°$ of driver rotation
